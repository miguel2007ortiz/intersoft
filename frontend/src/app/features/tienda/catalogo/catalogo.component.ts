          ...
          <nav class="acciones">
            @if (sesion(); as u) {
              <div class="cuenta">
                ...
                <button type="button" class="btn btn-secundario btn-sm" (click)="salir()">
                  Salir
                </button>
              </div>
            } @else {
            ...
            <a routerLink="/carrito" class="btn-carrito"> Carrito ({{ totalItems() }}) </a>
          </nav>
        </div>
      </header>
      ...
      <section class="hero" appBrilloCursor>
        ...
        <div class="contenedor hero-int">
          ...
          <h1 class="aparecer" style="--retraso: 90ms">
            Compra directo a las empresas<br /><span class="resaltado"
              >que ya conoces y confias</span
            >
          </h1>
          <p class="entrada aparecer" style="--retraso: 180ms">
            Un solo lugar para explorar el catalogo de tus proveedores favoritos, comparar precios y
            hacer seguimiento a tu pedido de principio a fin.
          </p>
        ...
        <div class="chips">
          ...
          @for (cat of categorias(); track cat.id) {
            <button
              type="button"
              class="chip"
              [class.chip-activo]="categoriaSeleccionada === cat.id"
